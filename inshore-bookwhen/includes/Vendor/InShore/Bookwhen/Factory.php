...
use InShore\Bookwhen\Vendor\Http\Discovery\Psr18ClientDiscovery;
use InShore\Bookwhen\Vendor\InShore\Bookwhen\Transporters\HttpTransporter;
use InShore\Bookwhen\Vendor\InShore\Bookwhen\ValueObjects\ApiKey;
use InShore\Bookwhen\Vendor\InShore\Bookwhen\ValueObjects\Transporter\BaseUri;
use InShore\Bookwhen\Vendor\InShore\Bookwhen\ValueObjects\Transporter\Headers;
use InShore\Bookwhen\Vendor\InShore\Bookwhen\ValueObjects\Transporter\QueryParams;
use InShore\Bookwhen\Vendor\Psr\Http\Client\ClientInterface;
use InShore\Bookwhen\Vendor\Symfony\Component\HttpClient\Psr18Client;
final class Factory
{
    /**
