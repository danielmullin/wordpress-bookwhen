...
namespace InShore\Bookwhen\Vendor\Respect\Validation;

use ReflectionClass;
use ReflectionException;
use ReflectionObject;
use InShore\Bookwhen\Vendor\Respect\Validation\Exceptions\ComponentException;
use InShore\Bookwhen\Vendor\Respect\Validation\Exceptions\InvalidClassException;
use InShore\Bookwhen\Vendor\Respect\Validation\Exceptions\ValidationException;
use InShore\Bookwhen\Vendor\Respect\Validation\Message\Formatter;
use InShore\Bookwhen\Vendor\Respect\Validation\Message\ParameterStringifier;
use InShore\Bookwhen\Vendor\Respect\Validation\Message\Stringifier\KeepOriginalStringName;
...
final class Factory
{
     ...
     * @var string[]
     */
    private $rulesNamespaces = ['InShore\\Bookwhen\\Vendor\\Respect\\Validation\\Rules'];
    /**
     * @var string[]
     */
    private $exceptionsNamespaces = ['InShore\\Bookwhen\\Vendor\\Respect\\Validation\\Exceptions'];
    /**
     * @var callable
     */
