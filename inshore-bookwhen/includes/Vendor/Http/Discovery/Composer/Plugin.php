...
namespace InShore\Bookwhen\Vendor\Http\Discovery\Composer;

use InShore\Bookwhen\Vendor\Composer\Composer;
use InShore\Bookwhen\Vendor\Composer\DependencyResolver\Pool;
use InShore\Bookwhen\Vendor\Composer\EventDispatcher\EventSubscriberInterface;
use InShore\Bookwhen\Vendor\Composer\Factory;
use InShore\Bookwhen\Vendor\Composer\Installer;
use InShore\Bookwhen\Vendor\Composer\IO\IOInterface;
use InShore\Bookwhen\Vendor\Composer\Json\JsonFile;
use InShore\Bookwhen\Vendor\Composer\Json\JsonManipulator;
use InShore\Bookwhen\Vendor\Composer\Package\Locker;
use InShore\Bookwhen\Vendor\Composer\Package\Version\VersionParser;
use InShore\Bookwhen\Vendor\Composer\Package\Version\VersionSelector;
use InShore\Bookwhen\Vendor\Composer\Plugin\PluginInterface;
use InShore\Bookwhen\Vendor\Composer\Repository\InstalledRepositoryInterface;
use InShore\Bookwhen\Vendor\Composer\Repository\RepositorySet;
use InShore\Bookwhen\Vendor\Composer\Script\Event;
use InShore\Bookwhen\Vendor\Composer\Script\ScriptEvents;
use InShore\Bookwhen\Vendor\Composer\Util\Filesystem;
...
class Plugin implements PluginInterface, EventSubscriberInterface
{
    ...
    private const INTERFACE_MAP = ['php-http/async-client-implementation' => ['InShore\\Bookwhen\\Vendor\\Http\\Client\\HttpAsyncClient'], 'php-http/client-implementation' => ['InShore\\Bookwhen\\Vendor\\Http\\Client\\HttpClient'], 'psr/http-client-implementation' => ['InShore\\Bookwhen\\Vendor\\Psr\\Http\\Client\\ClientInterface'], 'psr/http-factory-implementation' => ['InShore\\Bookwhen\\Vendor\\Psr\\Http\\Message\\RequestFactoryInterface', 'InShore\\Bookwhen\\Vendor\\Psr\\Http\\Message\\ResponseFactoryInterface', 'InShore\\Bookwhen\\Vendor\\Psr\\Http\\Message\\ServerRequestFactoryInterface', 'InShore\\Bookwhen\\Vendor\\Psr\\Http\\Message\\StreamFactoryInterface', 'InShore\\Bookwhen\\Vendor\\Psr\\Http\\Message\\UploadedFileFactoryInterface', 'InShore\\Bookwhen\\Vendor\\Psr\\Http\\Message\\UriFactoryInterface']];
    ...
    public function getMissingRequires(InstalledRepositoryInterface $repo, array $requires, bool $isProject, array $pinnedAbstractions) : array
    {
        ...
        if (ClassDiscovery::safeClassExists(\InShore\Bookwhen\Vendor\Phalcon\Http\Message\RequestFactory::class, \false)) {
