...
use InShore\Bookwhen\Vendor\GuzzleHttp\Cookie\CookieJar;
use InShore\Bookwhen\Vendor\GuzzleHttp\Exception\GuzzleException;
use InShore\Bookwhen\Vendor\GuzzleHttp\Exception\InvalidArgumentException;
 ...
 * @final
 */
class Client implements ClientInterface, \InShore\Bookwhen\Vendor\Psr\Http\Client\ClientInterface
{
    use ClientTrait;
    /**
